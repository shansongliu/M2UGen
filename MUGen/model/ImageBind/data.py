...
def load_and_transform_audio_data(
    ...
    for audio_path in audio_paths:
        ...
        # start = min(0, int(len(waveform) // sample_rate) - 10)
        # end = max(int(len(waveform) // sample_rate) - 9, 1)
        # idx = 0#random.randint(start, end)
        # waveform = waveform[idx*sample_rate: min((idx+1) * sample_rate, len(waveform))]
