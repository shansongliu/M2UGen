    ...
    def __init__(self):
        ...
        self.mucaps_dec = {
            ...
            "params": dict(
                data_path="./data/MUCaps/MUCapsCaptions.json",
                mm_root_path="./data/MUCaps/audios/",
                embed_path="./data/MUCaps/musicgen_embeds/",
        ...
        self.muimage_instruction = {
            ...
            "params": dict(
                ...
                embed_path="./data/MUImage/musicgen_embeds",
        ...
        self.muvideo_instruction = {
            ...
            "params": dict(
                ...
                embed_path="./data/MUVideo/musicgen_embeds",
        ...
        self.muedit_instruction = {
            ...
            "params": dict(
                ...
                embed_path="./data/MUEdit/musicgen_embeds",
