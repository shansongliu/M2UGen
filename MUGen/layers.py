...
class TextFcLayer(nn.Module):
    ...
    def init_Qformer(cls, num_query_token, vision_width, num_hidden_layers=2, cross_attention_freq=1):
        encoder_config = BertConfig.from_pretrained("/hpctmp/e0589920/bert-base-uncased")
        ...
        Qformer = BertLMHeadModel.from_pretrained("/hpctmp/e0589920/bert-base-uncased", config=encoder_config)
