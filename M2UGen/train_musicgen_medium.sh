...
mkdir -p "$OUTPUT_DIR"
 ...
 --epochs 500 --split_epoch 100 --warmup_epochs 0 --lr 1e-5 --weight_decay 0.05 \
 --mert_path /scratch2/e0589920/MERT-v1-330M/ --vit_path /scratch2/e0589920/ViT \
 --vivit_path /scratch2/e0589920/ViViT --music_decoder_path /scratch2/e0589920/musicgen-small \
